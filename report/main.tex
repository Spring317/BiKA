...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[>=stealth, thick]
        ...
        % D3 (KAN)
        \node[concat, minimum height=0.5cm, minimum width=1.6cm] (d3_concat) at (21,-4.8) {};
        ...
        % D2 (Conv)
        \node[concat, minimum height=1cm, minimum width=0.8cm] (d2_concat) at (23.5,-3.4) {};
        ...
        % D1 (Conv)
        \node[concat, minimum height=2cm, minimum width=0.4cm] (d1_concat) at (26,-1.8) {};
        ...
        % Final Conv (head)
        \node[conv, minimum height=4cm, minimum width=0.2cm] (head) at (28,0) {};
        \node[label, below=0.1cm of head] {Head};
        
        % Output
        \node[inner sep=0pt] (output) at (30.5,0) {\includegraphics[width=1.5cm,height=1.5cm]{images/bdd100k_samples/mask1.png}};
        \node[label, below=0.1cm of output] {$H \times W \times N_{\text{classes}}$};
        \node[label, above=0.1cm of output] {Output Mask};
        
        % Connections using orthogonal routing
        \draw[line] (input.east) -- (e1.west|-input.east) |- (e1.west);
        
        \draw[pool] (e1.east) -| (e2.north) node[pos=0.25, above, label, red!80!black] {Pool};
        \draw[pool] (e2.east) -| (e3.north) node[pos=0.25, above, label, red!80!black] {Pool};
        \draw[pool] (e3.east) -| (e4.north) node[pos=0.25, above, label, red!80!black] {Embed};
        \draw[pool] (e4.east) -| (b.north) node[pos=0.25, above, label, red!80!black] {Embed};
        
        \draw[up] (b.east) -| (d4_concat.south) node[pos=0.25, below, label, green!60!black] {Up};
        \draw[up] (d4.east) -| (d3_concat.south) node[pos=0.25, below, label, green!60!black] {Up};
        \draw[up] (d3.east) -| (d2_concat.south) node[pos=0.25, below, label, green!60!black] {Up};
        \draw[up] (d2.east) -| (d1_concat.south) node[pos=0.25, below, label, green!60!black] {Up};
        
        \draw[up] (d1.east) -| (head.south) node[pos=0.25, below, label, green!60!black] {Up};
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[>=stealth, thick]
        ...
        % Stem
        \node[fp, minimum height=4cm, minimum width=0.4cm] (stem) at (2.5,0) {};
        \node[label, below=0.1cm of stem] {$H \times W$\\$C$};
        \node[label, above=0.1cm of stem] {FP32 Stem};
        
        % Block 1
        \node[bin, minimum height=2cm, minimum width=0.8cm] (e1) at (5,-1.8) {};
        \node[label, below=0.1cm of e1] {$\frac{H}{2} \times \frac{W}{2}$\\$2C$};
        \node[label, above=0.1cm of e1] {BiKA 1};
        
        % Block 2
        \node[bin, minimum height=1cm, minimum width=1.6cm] (e2) at (7.5,-3.4) {};
        \node[label, below=0.1cm of e2] {$\frac{H}{4} \times \frac{W}{4}$\\$4C$};
        \node[label, above=0.1cm of e2] {BiKA 2};
        
        % Bottleneck
        \node[bottleneck, minimum height=0.5cm, minimum width=3.2cm] (b) at (11,-4.8) {};
        \node[label, below=0.1cm of b] {$\frac{H}{8} \times \frac{W}{8}$\\$8C$};
        \node[label, above=0.1cm of b] {Bottleneck};
        
        % Decoder 2
        \node[concat, minimum height=1cm, minimum width=1.6cm] (d2_concat) at (14.5,-3.4) {};
        ...
        % Decoder 1
        \node[concat, minimum height=2cm, minimum width=0.8cm] (d1_concat) at (17,-1.8) {};
        ...
        % Decoder 0
        \node[concat, minimum height=4cm, minimum width=0.4cm] (d0_concat) at (19.5,0) {};
        ...
        % Head
        \node[fp, minimum height=4cm, minimum width=0.2cm] (head) at (22,0) {};
        \node[label, below=0.1cm of head] {FP32 Head};
        
        % Output
        \node[inner sep=0pt] (output) at (24.5,0) {\includegraphics[width=1.5cm,height=1.5cm]{images/bdd100k_samples/mask1.png}};
        \node[label, below=0.1cm of output] {$H \times W \times N_{\text{classes}}$};
        \node[label, above=0.1cm of output] {Output Mask};
        
        % Connections using orthogonal routing
        \draw[conv] (input.east) -- (stem.west|-input.east) |- (stem.west);
        
        \draw[pool] (stem.east) -| (e1.north) node[pos=0.25, above, label, red!80!black] {Pool $2\times2$};
        \draw[pool] (e1.east) -| (e2.north) node[pos=0.25, above, label, red!80!black] {Pool $2\times2$};
        \draw[pool] (e2.east) -| (b.north) node[pos=0.25, above, label, red!80!black] {Pool $2\times2$};
        
        \draw[up] (b.east) -| (d2_concat.south) node[pos=0.25, below, label, green!60!black] {Up $2\times2$};
        \draw[up] (d2.east) -| (d1_concat.south) node[pos=0.25, below, label, green!60!black] {Up $2\times2$};
        \draw[up] (d1.east) -| (d0_concat.south) node[pos=0.25, below, label, green!60!black] {Up $2\times2$};
