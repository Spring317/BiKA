...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[>=stealth, thick]
        ...
        % D3 (KAN)
        \node[concat, minimum height=0.6cm, minimum width=1.6cm] (d3_concat) at (16,-6) {};
        ...
        % D2 (Conv)
        \node[concat, minimum height=1.2cm, minimum width=0.8cm] (d2_concat) at (18,-4) {};
        ...
        % D1 (Conv)
        \node[concat, minimum height=2.4cm, minimum width=0.4cm] (d1_concat) at (19.5,-2) {};
